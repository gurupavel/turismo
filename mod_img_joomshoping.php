...
if(isset($_POST['mod_img_joomshoping_submitted']))
{
    ...
    require( JModuleHelper::getLayoutPath( 'mod_img_joomshoping', "success" ) );
}
else
{
    require( JModuleHelper::getLayoutPath( 'mod_img_joomshoping' ) );
}